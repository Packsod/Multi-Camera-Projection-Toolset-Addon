...
bl_info = {
    ...
    "description": "A set of tools for multires projecting",
    "warning": "",
    "doc_url": "",
    "category": "3D View",
}
...
def create_operator_4(def_name, label):
...
categories["mp_shader"]["operators"] = [
    ...
    create_operator_2("shader_mask.CamP_set__1", "", "SEQUENCE_COLOR_01"),
    create_operator_2("shader_mask.CamP_set__2", "", "SEQUENCE_COLOR_02"),
    create_operator_2("shader_mask.CamP_set__3", "", "SEQUENCE_COLOR_03"),
    create_operator_2("shader_mask.CamP_set__4", "", "SEQUENCE_COLOR_04"),
    create_operator_2("shader_mask.CamP_set__5", "", "SEQUENCE_COLOR_05"),
    create_operator_2("shader_mask.CamP_set__6", "", "SEQUENCE_COLOR_06"),
    create_operator_2("shader_mask.CamP_set__7", "", "SEQUENCE_COLOR_07"),
    create_operator_2("shader_mask.CamP_set__8", "", "SEQUENCE_COLOR_08"),
    ...
    create_operator_2("adij_mask.ADIJ_set__1", "", "SEQUENCE_COLOR_01"),
    create_operator_2("adij_mask.ADIJ_set__2", "", "SEQUENCE_COLOR_02"),
    create_operator_2("adij_mask.ADIJ_set__3", "", "SEQUENCE_COLOR_03"),
    create_operator_2("adij_mask.ADIJ_set__4", "", "SEQUENCE_COLOR_04"),
    create_operator_2("adij_mask.ADIJ_set__5", "", "SEQUENCE_COLOR_05"),
    create_operator_2("adij_mask.ADIJ_set__6", "", "SEQUENCE_COLOR_06"),
    create_operator_2("adij_mask.ADIJ_set__7", "", "SEQUENCE_COLOR_07"),
    create_operator_2("adij_mask.ADIJ_set__8", "", "SEQUENCE_COLOR_08"),
...
categories["mp_cam_and_tex"]["operators"] = [
    create_operator_1("tex_projecting_overpaint", "project to obj", "RENDER_RESULT"),
...
categories["mp_Combo_op"]["operators"] = [
    create_operator_2("vcol_mask.CamP_ID_1", " ", "SEQUENCE_COLOR_01"),
    create_operator_2("vcol_mask.CamP_ID_2", " ", "SEQUENCE_COLOR_02"),
    create_operator_2("vcol_mask.CamP_ID_3", " ", "SEQUENCE_COLOR_03"),
    create_operator_2("vcol_mask.CamP_ID_4", " ", "SEQUENCE_COLOR_04"),
    create_operator_2("vcol_mask.CamP_ID_5", " ", "SEQUENCE_COLOR_05"),
    create_operator_2("vcol_mask.CamP_ID_6", " ", "SEQUENCE_COLOR_06"),
    create_operator_2("vcol_mask.CamP_ID_7", " ", "SEQUENCE_COLOR_07"),
    create_operator_2("vcol_mask.CamP_ID_8", " ", "SEQUENCE_COLOR_08"),
    create_operator_2("vcol_mask.CamP_ID_toggle", " ", "HIDE_OFF"),
    create_operator_2("vcol_mask.CamP_ID_delete", " ", "TRASH"),

    create_operator_2("vcol_mask.col_adijust_1", " ", "SEQUENCE_COLOR_01"),
    create_operator_2("vcol_mask.col_adijust_2", " ", "SEQUENCE_COLOR_02"),
    create_operator_2("vcol_mask.col_adijust_3", " ", "SEQUENCE_COLOR_03"),
    create_operator_2("vcol_mask.col_adijust_4", " ", "SEQUENCE_COLOR_04"),
    create_operator_2("vcol_mask.col_adijust_5", " ", "SEQUENCE_COLOR_05"),
    create_operator_2("vcol_mask.col_adijust_6", " ", "SEQUENCE_COLOR_06"),
    create_operator_2("vcol_mask.col_adijust_7", " ", "SEQUENCE_COLOR_07"),
    create_operator_2("vcol_mask.col_adijust_8", " ", "SEQUENCE_COLOR_08"),
    ...
    create_operator_2("vcol_mix.cel_littone", "lit", "BRUSH_TEXFILL"),
    create_operator_2("vcol_mix.cel_midtone", "mid", "BRUSH_SOFTEN"),
    create_operator_2("vcol_mix.cel_darktone", "dim", "BRUSH_TEXMASK"),

    create_operator_2("vcol_mix.remove_littone", "X", "BRUSH_TEXFILL"),
    create_operator_2("vcol_mix.remove_midtone", "X", "BRUSH_SOFTEN"),
    create_operator_2("vcol_mix.remove_darktone", "X", "BRUSH_TEXMASK"),
...
categories["mp_nodegroups"]["operators"] = [   
    ...
    create_operator_4("ShaderAdder.npr_Key_Light", ".npr_Key Light"),
    create_operator_4("ShaderAdder.npr_Specular", ".npr_Specular"),
    create_operator_4("ShaderAdder.npr_Virtual_Point_Light", ".npr_Virtual Point Light"),
    create_operator_4("ShaderAdder.npr_Virtual_Spot_Light", ".npr_Virtual Spot Light"),
    create_operator_4("ShaderAdder.npr_Virtual_Sun_Light", ".npr_Virtual Sun Light"),
#4
    create_operator_4("ShaderAdder.npr_layer_mix_shader", ".(09) npr_layer_mix_shader"),
    create_operator_4("ShaderAdder.npr_Color", ".npr_Color"),
    create_operator_4("ShaderAdder.npr_Layer_Adjustment", ".npr_Layer Adjustment"),
    create_operator_4("ShaderAdder.npr_Global_Color", ".npr_Global Color"),
#8        
    create_operator_4("ShaderAdder.npr_Linear_Gradient", ".npr_Linear Gradient"),
    create_operator_4("ShaderAdder.npr_Spherical_Gradient", ".npr_Spherical Gradient"),
    create_operator_4("ShaderAdder.npr_Local_Gradient", ".npr_Local Gradient"),
    create_operator_4("ShaderAdder.npr_Z_Depth", ".npr_Z Depth"),
#12
    create_operator_4("ShaderAdder.npr_2D_Outline", ".npr_2D Outline"),
    create_operator_4("ShaderAdder.npr_2D_Rim_Light", ".npr_2D Rim Light",),
    create_operator_4("ShaderAdder.npr_2D_Specular", ".npr_2D Specular"),
    create_operator_4("ShaderAdder.npr_Matcap", ".npr_Matcap"),
#16
    create_operator_4("ShaderAdder.npr_Ambient_Occlusion_Baked", ".npr_Ambient Occlusion (Baked)"),
    create_operator_4("ShaderAdder.npr_Ambient_Occlusion_SS", ".npr_Ambient Occlusion (SS)"),
#18
    create_operator_4("ShaderAdder_add_Halftone_Style", ".Halftone Style"),
    create_operator_4("ShaderAdder_add_Hatch_Style", ".Hatch Style"),
    create_operator_4("ShaderAdder_add_Painterly_Style", ".Painterly Style"),
    create_operator_4("ShaderAdder_add_Anisotropic_Style", ".Anisotropic Style"),
]
